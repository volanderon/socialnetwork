<div id="profile-cover" class="box">
    ...
    <div class="pc-footer">
        ...
        <div class="pc-actions">
            <?php if ($page['is_me']): ?><div class="pca-icon change-cover-icon"><a href="account.php#images"></a></div><?php endif; ?>
            <?php if (!$page['is_me']): ?><div class="pca-icon add-friend-icon"></div><?php endif; ?>
            <?php if (!$page['is_me']): ?><div class="pca-icon remove-friend-icon"></div><?php endif; ?>
        </div>
    </div>
</div>